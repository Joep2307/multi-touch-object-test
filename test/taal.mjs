...
for (const n of ["index.html", "app.js", "kg.js", "speech.js", "styles.css"])
  fs.copyFileSync(path.join(root, n), path.join(work, n));
  ...
  `export function defaultClient(){return{graph:async()=>({nodes:[],links:[]}),documents:async()=>[],chat:async function*(){}};}\nexport default {defaultClient};\n`);
{
  ...
  if (!p.includes(tag)) { console.error("index.html laadt app.js niet zoals verwacht"); process.exit(2); }
