...
export const L: Record<Lang, Phrases> = {
  en:{ good:"Good", bad:"Problem", talk:"Discussion", idea:"Idea",
       ...
       /* Uit de tafelversie van 5 september. */
       puckPickTopic:"Pick a theme",
       duoTheme:"Duo",
       duoTool:"Duo · tools",
       duoToolFace:"Tools",
       ...
       duoTurn:"Turn · or tap the hole",
       puckPickTool:"Pick a tool",
       duoMeasureOn:"Measure on",
       duoMeasureOff:"Measure off",
       duoShot:"Photo",
       duoRec:"Record",
       duoRecStop:"Stop recording",
       duoApart:"Pull the two halves apart",
       helpTitle:"How the puck works",
       helpTurn:"Turn · zoom",
       helpMove:"Slide · travel",
       helpTap:"Tap centre · choose",
       capture:"Capture",
       captureHead:"CAPTURE",
       capShot:"Photo of the map",
       capRec:"Start recording",
       capRecStop:(t)=>`Stop recording \u00b7 ${t}`,
       capLapse:"Start time-lapse",
       capLapseStop:(n)=>`Stop time-lapse \u00b7 ${n} frames`,
       ...
       recogHoldSlots:(n)=>`<b>${n}</b> feet in the grid \u2014 hold still\u2026`,
       recogMeasuredSlots:(c,mm)=>`Measured: grid code ${c}, radius ${mm} mm.`,
       recogSavedSlots:(name,c,mm)=>`<b>${name}</b> remembered \u2014 grid code ${c}, radius ${mm} mm. This screen keeps it after a reload.`,
       recogSlotSym:"This code looks like itself when the puck is turned one slot further. The table then struggles to see which way is forward, and the puck flips from frame to frame. Move one foot to another slot and measure again.",
       ...
       sheetGaps:"Gaps",
       sheetRing:"Radius",
       sheetCode:"Grid code", sheetSlots:"Grid", sheetProposal:"To print",
       ...
       contactEmailPh:"name@example.com",
       ...
       contactSave:"Save contact details",
       ...
       contactInvalidEmail:"Check the email address.",
       contactSaved:"Contact details saved.",
       talkLangGroup:"Language of the conversation",
       talkLangAuto:"Auto",
  ...
  nl:{ good:"Goed", bad:"Probleem", talk:"Discussie", idea:"Idee",
       ...
       /* Uit de tafelversie van 5 september. */
       puckPickTopic:"Kies een thema",
       duoTheme:"Duo",
       duoTool:"Duo · gereedschap",
       duoToolFace:"Gereedschap",
       ...
       duoTurn:"Draai · of tik het gat aan",
       puckPickTool:"Kies gereedschap",
       duoMeasureOn:"Meten aan",
       duoMeasureOff:"Meten uit",
       duoShot:"Foto",
       duoRec:"Opname",
       duoRecStop:"Opname stoppen",
       duoApart:"Leg de twee helften uit elkaar",
       helpTitle:"Zo werkt de puck",
       helpTurn:"Draai · zoom",
       helpMove:"Schuif · reis",
       helpTap:"Tik midden · kies",
       capture:"Vastleggen",
       captureHead:"VASTLEGGEN",
       capShot:"Foto van de kaart",
       capRec:"Opname starten",
       capRecStop:(t)=>`Opname stoppen \u00b7 ${t}`,
       capLapse:"Tijdlapse starten",
       capLapseStop:(n)=>`Tijdlapse stoppen \u00b7 ${n} beelden`,
       ...
       recogHoldSlots:(n)=>`<b>${n}</b> pootjes in het rooster \u2014 stil houden\u2026`,
       recogMeasuredSlots:(c,mm)=>`Gemeten: roostercode ${c}, straal ${mm} mm.`,
       recogSavedSlots:(name,c,mm)=>`<b>${name}</b> onthouden \u2014 roostercode ${c}, straal ${mm} mm. Dit scherm weet het ook na herladen.`,
       recogSlotSym:"Deze code lijkt op zichzelf als je de puck één vakje verder draait. De tafel ziet dan moeilijk welke kant voor is, en de puck klapt van beeld tot beeld om. Verzet één pootje naar een ander vakje en meet opnieuw.",
       ...
       sheetGaps:"Gaten",
       sheetRing:"Straal",
       sheetCode:"Roostercode", sheetSlots:"Rooster", sheetProposal:"Om te printen",
       ...
       contactName:"Naam (optioneel)",
       contactNamePh:"Je naam",
       contactEmail:"E-mail (optioneel)",
       contactEmailPh:"naam@voorbeeld.nl",
       contactPhone:"Telefoon (optioneel)",
       contactPhonePh:"06 …",
       contactConsent:"Ja, ik geef toestemming om mij over deze bijdrage te benaderen.",
       contactSkip:"Nee, bedankt",
       contactSave:"Contact bewaren",
       ...
       contactInvalidEmail:"Controleer het e-mailadres.",
       contactSaved:"Contactgegevens bewaard.",
       talkLangGroup:"Taal van het gesprek",
       talkLangAuto:"Auto",
