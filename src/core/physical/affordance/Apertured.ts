 ...
 * outer diameter — the old code's `PUCK_HOLE`, 0.58. Kept as a
 * fraction rather than millimetres so a bigger puck of the same design
 * needs no second number.
 */
export class Apertured extends Affordance {
    override readonly id = "apertured";

    constructor(readonly holeFraction: number = 0.58) {
        super();
    }
}
